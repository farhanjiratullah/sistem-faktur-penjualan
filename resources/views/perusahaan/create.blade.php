...
@section('title', 'Tambah Perusahaan - Sistem Faktur Penjualan')
...
@section('content')
    <div class="p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-2xl font-bold text-gray-800">Tambah Data Perusahaan</h1>
                <p class="text-gray-600 mt-1">Isi form berikut untuk menambahkan data perusahaan baru</p>
            </div>
